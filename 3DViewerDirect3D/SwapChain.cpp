...
SwapChain::SwapChain(HWND hwnd, ID3D11Device1* d3d11Device, ID3D11DeviceContext1* d3d11DeviceContext, int width, int height)
{
    ...
    hResult = m_pSwapChain->GetBuffer(0, __uuidof(ID3D11Texture2D), (void**)&d3d11FrameBuffer);

    hResult = d3d11Device->CreateRenderTargetView(d3d11FrameBuffer, nullptr, m_pFrameBuffer.ReleaseAndGetAddressOf());
